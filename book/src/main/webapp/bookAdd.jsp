	...
	<div class="container-fluid" style="width: 80%;">
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<form action="bookAdd" method="post" enctype="multipart/form-data" id="bookForm">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									...
									<textarea class="form-control" id="inputDescri"
										placeholder="出版描述" name="descri"></textarea>
								</div>
							</div>
...
<script type="text/javascript" src="bower_components/jquery-validation/src/localization/messages_zh.js">
</script>
<script type="text/javascript">
$(function(){
    $("#bookForm").validate({
